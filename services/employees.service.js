...
module.exports.addOrEditEmployees = async(obj,id=0) =>{

    const [[[{affectedRows}]]] = await db.query("CALL usp_employees_add_or_edit(?,?,?,?)" ,[id, obj.name, obj.employee_code, obj.salary])
